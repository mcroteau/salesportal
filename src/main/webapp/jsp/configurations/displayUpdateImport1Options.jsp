...
<%// DMP Prospect Importal section ..........................................%>
       <tr>
        <td colspan="3">
          <b><font color="blue">Data Migration Portal - Prospect Import - this is a duplicate of the DMP1 jsp</font></b>
        </td>
      </tr>
      <tr>
        <td colspan="3">
      ...
      <tr>
       ...
       <tr>
        <td width="50"></td>
        <td width="200"><b>Commission Import File Prefix:</b></td>
        <td ><input name="OPT_INVOICE_IMPORT_FILE_PREFIX" value="<%=AppSettings.getParm("INVOICE_IMPORT_FILE_PREFIX")%>" size=50 onblur="fOnFieldBlur(this);"></td>
      </tr>
...
<%// Other Importal Options section ..........................................%>
      ...
      <tr>
        <td width="50"></td>
        <td width="200"><b>Is Send Email Enabled (TRUE/FALSE)(SMTP settings are in Application Options):</b></td>
