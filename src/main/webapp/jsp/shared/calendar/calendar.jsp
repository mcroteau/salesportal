...
<style>
	td {font-family: Arial, Tahoma, Verdana, sans-serif; font-size: 11px;}
...
var STR_ICONPATH = '<%=AppSettings.getAppWebPath()%>graphics/';
...
for (var n=0; n<7; n++)
	document.write('<td bgcolor="#636563" align="center"><font color="#ffffff">'+ARR_WEEKDAYS[(NUM_WEEKSTART+n)%7]+'</font></td>');
document.write('</tr>');
...
while (dt_current_day.getMonth() == dt_current.getMonth() ||
	...
	for (var n_current_wday=0; n_current_wday<7; n_current_wday++) {
		if (dt_current_day.getDate() == dt_current.getDate() &&
			...
			// print current date
			document.write('<td bgcolor="#aabbff" align="center" width="14%">');
